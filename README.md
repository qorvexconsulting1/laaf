...
[![CI](https://github.com/qorvex-research/laaf/actions/workflows/ci.yml/badge.svg)](https://github.com/qorvex-research/laaf/actions)
...
Payload Generator  ──►  Stage Engine (S1→S2→S3→S4→S5→S6)
              ...
              Attack Executor ──► Target LLM API
                                │
                                ▼
              Response Analyser (EXECUTED / BLOCKED / WARNING)
                                │
                    ┌───────────┴───────────┐
                    ▼                       ▼
...
|---|---|
| `c < 10` | Seed variation — minor variants of winning payload |
| `10 ≤ c < 20` | Encoding mutation — switch technique category |
| `c ≥ 20` | Compound mutation — stack multiple techniques |
