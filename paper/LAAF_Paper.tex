...
\lhead{\small\textit{Atta et al., Qorvex Research, 2026}}
\cfoot{\small\thepage}
...
\begin{center}
  ...
  {\normalsize
    Hammad Atta, Ken Huang, Manish Bhatt, Kamal Ahmed,
    M. Aziz Ul Haq, Yasir Mehmood}\\[6pt]
...
\smallskip\noindent$\star$\,\textbf{Corresponding author:} Hammad Atta,
Qorvex Consulting \& Roshan Consulting.
...
The authors thank the OWASP LLM Top~10 working group and MITRE ATLAS team
for engagement with LPCI research.  This work is not related to any
co-author's position at their respective employers.
